        ...
        <nav id="navbar" class="fixed top-0 left-0 w-full bg-[#D0E1F5] p-6 font-body z-50">
            <div class="flex items-center justify-between flex-wrap">
                ...
                <div class="w-full block lg:flex lg:items-center lg:w-auto mr-20">
                  ...
                  <div>
                    <a href="/dashboard" class="bg-customBlue font-medium inline-block text-lg px-6 py-3 leading-none rounded-md text-white hover:bg-[#B5179E] mt-4 lg:mt-0">Dashboard</a>
                  </div>
                </div>
            </div>
        </nav>
